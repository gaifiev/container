            ...
            <div class="footer__items">
                <div class="footer__item">
                    <div class="footer__logo">
                        <img class="footer__img" src="/img/header/logo.png" alt="logo">
                        <h4 class="footer__title">Inferno</h4>
                    </div>
                ...
                <div class="footer__item">
                    <h5 class="footer__titles-bold">Pages</h5>
                    <a href="./index.html" class="footer__titles">Home</a>
                    <a href="#" class="footer__titles">Project</a>
                    <a href="./blog.html" class="footer__titles">Blog</a>
                </div>
                <div class="footer__item">
                    <h5 class="footer__titles-bold">Contact</h5>
                    <h5 class="footer__titles">55 East Birchwood. Brooklyn, New York 11201</h5>
                    <h5 class="footer__titles">Ave.contact@interno.com</h5>
                    <h5 class="footer__titles">(123) 456 - 7890</h5>
                </div>
            </div>
        </footer>
    </div>
...
<script>
export default {
    name: 'WorkspaceJsonFooterComponent',
